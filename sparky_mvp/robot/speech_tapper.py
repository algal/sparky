"""Audio-to-sway analysis for speech-synchronized head movement.

Copied from reachy_mini_conversation_app/audio/speech_tapper.py (2026-02-08).
Converts PCM audio into per-hop (50ms) sway/roll offsets for HeadWobbler.
"""
